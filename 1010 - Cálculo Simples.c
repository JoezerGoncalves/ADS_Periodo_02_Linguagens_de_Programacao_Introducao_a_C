...
deixar um espaço após os dois pontos e um espaço após o "R$". 
...
int main() {
    ...
    scanf("%d %d %f", &cod, &quant, & val); //a primeira
    valt = quant*val; //total primeira linha
    
    scanf("%d %d %f", &cod, &quant, & val); //a primeira
    valt += quant * val; //valt = valt + (quant*val)
