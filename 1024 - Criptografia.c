...
consiga lê-las. O processo é muito simples. São feitas três passadas em 
todo o texto.
...
tabela ASCII: letra 'a' deve virar letra 'd', letra 'y' deve virar caractere '|' 
...
com o deslocamento dos caracteres da metade em diante, o resultado final 
deve ser “3# rvzgV”.

Entrada
A entrada contém vários casos de teste. A primeira linha de cada caso 
de teste contém um inteiro N (1 = N = 1*104), indicando a quantidade 
de linhas que o problema deve tratar. As N linhas contém cada uma 
